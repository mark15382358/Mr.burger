...
import 'package:mr_burger/features/product/presentation/view/product_details_view.dart';
      ...
      itemBuilder: (BuildContext context, index) {
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ProductDetailsView(productId: product.id, productImage: product.image, productPrice: product.price)),
            );
          },
          child: CardItem(
            price: product.price,
